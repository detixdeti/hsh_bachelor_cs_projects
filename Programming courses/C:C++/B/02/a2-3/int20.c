...
//
// Hinweise:
// � F�r die Funktion create20 sieht der Prototyp so aus:
//   struct int20 create20(char* val);
// � Die Addition k�nnen Sie so implementieren, wie Sie sie
//   einmal in der Schule gelernt haben (ziffernweise bei der
//   letzten Ziffer beginnend, jeweils mit �bertragsrechnung).
